...
| Canonical review routing | WARN | 19 questions |
...
| 13 | 13 | 5 |  | 4 | high | False | Read the given statements and conclusions carefully. Assuming that the information given in the statements is true, even if it app |
...
| 21 | 21 | 7 |  | 4 | high | False | Select the option in which the words share the same relationship as that shared by the given pair of words. Clock : Time |
...
| 54 | 4 | 15 | 2: 18/11 | 2 | high | False | If x, y, z are three integers such that x + y = 8, y + z = 13 and z + x = 17, then the value of x²/yz is: |
...
| 82 | 7 | 23 | 2: vital | 2 | high | False | Select the most appropriate option for blank No. 1 |
| 83 | 8 | 23 | 4: conscious | 4 | high | False | Select the most appropriate option for blank No. 2 |
| 84 | 9 | 23 | 3: ability | 3 | high | False | Select the most appropriate option for blank No. 3 |
