...
- Load errors: [{'page': 13, 'warnings': ['Question 23 and 24 options were labeled a, b, c, d in the source; mapped to 1, 2, 3, 4 for schema compliance.', 'The first block of text (60 * 48 * 36 * 6 * 15 * 53) is an incomplete question stem without a question number or clear answer options, so it was excluded.'], 'failure_type': 'json_or_schema_failure', 'retryable': True}, {'page': 14, 'warnings': ['The original options were labeled a, b, c, d. They have been mapped to 1, 2, 3, 4 for the schema requirements.'], 'failure_type': 'json_or_schema_failure', 'retryable': True}, {'page': 29, 'warnings': ['Question 68 only has 3 options visible in the image. Added a placeholder for the 4th option to satisfy schema requirements.'], 'failure_type': 'json_or_schema_failure', 'retryable': True}, {'page': 32, 'warnings': ['Question 75 is incomplete on the page (missing options).', 'Question 74 options were labeled a, b, c, d in the source; mapped to 1, 2, 3, 4 for schema compliance.'], 'failure_type': 'json_or_schema_failure', 'retryable': True}]
...
|---|---|---|
| Page JSON parse | FAIL | 4 failures |
